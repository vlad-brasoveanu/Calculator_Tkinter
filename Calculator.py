...
def btn_equal():
    try :
        global expression
        rezult = str(eval(expression))
        input_text.set(rezult)
        expression = ""
    except Exception:
        expression = ""
...
input_frame = Frame(container, width = 312, height = 50, bd = 0, highlightbackground = "black", highlightcolor = "black", highlightthickness = 1)
...
btns_frame = Frame(container, width = 312, height = 272.5, bg = "grey")
btns_frame.pack()
